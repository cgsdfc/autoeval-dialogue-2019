...
\begin{document}
    ...
    \paragraph{LSDSCC}
    LSDSCC \cite{LSDSCC} is a \emph{Large Scale Domain Specific Coversation Corpus} collected from the movie subreddit of the Reddit forum. It is believed that more specific domain can help avoid generating universal responses \cite{LSDSCC}. The authors applied dedicated cleansing procedures to the raw data to retain as much information as possible and used human annotations to ensure the quality of the corpus.
