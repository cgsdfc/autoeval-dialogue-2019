...
\begin{document}
    ...
    With the clusterings shown in figure \ref{fig:hierarchy}, we can clearly observe a hierarchy of agreement among the metrics. The clusters that was created in the earlier iterations appear closer to the leaves of the tree, which indicates stronger agreements or higher pairwise correlations of the corresponding metrics.

    %    and the overall clustering structure is similar across different settings.
